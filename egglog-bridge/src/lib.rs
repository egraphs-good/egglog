...
use crate::core_relations::{
    ...
    ExternalFunctionId, MergeVal, Offset, PlanStrategy, SequenceContainerValue, SortedWritesTable,
    TableId, TableIdentity, TaggedRowBuffer, Value, WrappedTable,
};
...
impl EGraph {
    ...
    pub fn get_container_value<C: ContainerValue>(&mut self, val: C) -> Value {
        ...
        let (value, changed) = self.db.with_execution_state_tracked(None, |state| {
