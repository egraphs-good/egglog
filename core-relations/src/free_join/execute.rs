...
mod top_index_tests {
    ...
    use super::{
        AccessId, BindingInfo, CatalogContinuation, ContinuationPosition, Database,
        ...
        PreparedTailMasks, RootContinuationCache, RootProjection, SmallColumnIndex,
        SmallColumnSink, TOP_INDEX_RANGES_PER_WORKER, TopLevelPartition, TrieNode,
        cached_coarse_scan_morsel_size, coarse_scan_morsel_size, cover_scan_bounds,
