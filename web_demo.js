...
__exports.run_program = function(input) {
    ...
    const ret = wasm.run_program(ptr0, len0);
...
class Result {
    ...
    get text() {
        ...
        try {
            ...
            wasm.__wbg_get_result_text(retptr, this.__wbg_ptr);
    ...
    set text(arg0) {
        ...
        const len0 = WASM_VECTOR_LEN;
        wasm.__wbg_set_result_text(this.__wbg_ptr, ptr0, len0);
    }
    /**
     * @returns {string}
     */
    get dot() {
        ...
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.__wbg_get_result_dot(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            deferred1_0 = r0;
            deferred1_1 = r1;
    ...
    set dot(arg0) {
        const ptr0 = passStringToWasm0(arg0, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.__wbg_set_result_dot(this.__wbg_ptr, ptr0, len0);
    }
    /**
     * @returns {string}
     */
    get json() {
        ...
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.__wbg_get_result_json(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            deferred1_0 = r0;
            deferred1_1 = r1;
    ...
    set json(arg0) {
        const ptr0 = passStringToWasm0(arg0, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.__wbg_set_result_json(this.__wbg_ptr, ptr0, len0);
    }
}
...
function __wbg_get_imports() {
    const imports = {};
    imports.wbg = {};
    imports.wbg.__wbg_log_d0d3f3b59b02e988 = function(arg0, arg1, arg2, arg3) {
        log(getStringFromWasm0(arg0, arg1), getStringFromWasm0(arg2, arg3));
    };
