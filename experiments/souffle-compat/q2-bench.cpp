...
namespace  souffle {
using namespace souffle;
class Sf_q2_bench: public SouffleProgram {
public:
 Sf_q2_bench();
 ~Sf_q2_bench();
void run();
...
void Sf_q2_bench::runFunction(std::string inputDirectoryArg,std::string outputDirectoryArg,bool performIOArg,bool pruneImdtRelsArg){
...
void Sf_q2_bench::run(){
runFunction("", "", false, false);
}

void Sf_q2_bench::runAll(std::string inputDirectoryArg,std::string outputDirectoryArg,bool performIOArg,bool pruneImdtRelsArg){
runFunction(inputDirectoryArg, outputDirectoryArg, performIOArg, pruneImdtRelsArg);
}

void Sf_q2_bench::printAll([[maybe_unused]] std::string outputDirectoryArg){
try {std::map<std::string, std::string> directiveMap({{R"_(IO)_",R"_(stdoutprintsize)_"},{R"_(attributeNames)_",R"_(a	b	leader)_"},{R"_(auxArity)_",R"_(0)_"},{R"_(name)_",R"_(MulView)_"},{R"_(operation)_",R"_(printsize)_"},{R"_(params)_",R"_({"records": {"Math": {"arity": 4, "params": ["tag", "a", "b", "n"]}}, "relation": {"arity": 3, "params": ["a", "b", "leader"]}})_"},{R"_(types)_",R"_({"ADTs": {}, "records": {"r:Math": {"arity": 4, "types": ["i:number", "r:Math", "r:Math", "i:number"]}}, "relation": {"arity": 3, "types": ["r:Math", "r:Math", "r:Math"]}})_"}});
...
void Sf_q2_bench::loadAll([[maybe_unused]] std::string inputDirectoryArg){
}

void Sf_q2_bench::dumpInputs(){
}

void Sf_q2_bench::dumpOutputs(){
...
SymbolTable& Sf_q2_bench::getSymbolTable(){
return symTable;
}

RecordTable& Sf_q2_bench::getRecordTable(){
return recordTable;
}

void Sf_q2_bench::setNumThreads(std::size_t numThreadsValue){
...
void Sf_q2_bench::executeSubroutine(std::string name,const std::vector<RamDomain>& args,std::vector<RamDomain>& ret){
if (name == "AddView") {
stratum_AddView_37d50e25a50e9062.run(args, ret);
return;}
if (name == "ConstView") {
...
namespace souffle {
SouffleProgram *newInstance_q2_bench(){return new  souffle::Sf_q2_bench;}
SymbolTable *getST_q2_bench(SouffleProgram *p){return &reinterpret_cast<souffle::Sf_q2_bench*>(p)->getSymbolTable();}
} // namespace souffle
...
namespace  souffle {
using namespace souffle;
class factory_Sf_q2_bench: souffle::ProgramFactory {
public:
...
namespace  souffle {
using namespace souffle;
souffle::SouffleProgram* factory_Sf_q2_bench::newInstance(){
return new  souffle::Sf_q2_bench();
}

 factory_Sf_q2_bench::factory_Sf_q2_bench():
souffle::ProgramFactory("q2_bench"){
}
...
extern "C" {
souffle::factory_Sf_q2_bench __factory_Sf_q2_bench_instance;
}
#endif
} // namespace souffle
