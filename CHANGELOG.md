...
- Speed up `core-relations`' `merge_all` by resetting only the tables that changed during the call instead of every table, avoiding work that grew with the total number of tables.
