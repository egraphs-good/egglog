...
- The term/proof encoding now supports `:no-merge` functions. Conflicting sets fail with the same error as the standard encoding, repeated sets of a canonically equal value succeed, and rejected candidates are never queryable or provable.
