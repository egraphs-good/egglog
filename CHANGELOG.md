...
- **Automatic naive demotion.** Rules that read or write the database in ways seminaive can't track auto-demote, with a `log::warn!` naming the offending primitive(s).
