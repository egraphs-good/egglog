...
pub struct FuncType {
    ...
    pub output: ArcSort,
    /// Internal hidden functions are generated by proof/term encoding and are
    /// not user-visible table lookups.
...
impl TypeInfo {
    ...
    fn function_to_functype(&self, func: &FunctionDecl) -> Result<FuncType, TypeError> {
        ...
        Ok(FuncType {
            ...
            input,
            output: output.clone(),
            internal_hidden: func.internal_hidden,
        })
    }
