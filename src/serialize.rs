...
impl EGraph {
    ...
    ///   (Note that this will be changed in `<https://github.copom/egraphs-good/egglog/pull/158>` so that edges point to exact nodes instead of looking up the e-class)
