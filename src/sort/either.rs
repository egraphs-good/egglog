...
impl ContainerSort for EitherSort {
    ...
    fn register_primitives(&self, eg: &mut EGraph) {
        ...
        add_primitive!(eg, "either-left" = {self.clone(): EitherSort} |left: # (self.left())| -> @EitherContainer (arc) {
            EitherContainer {
        ...
        add_primitive!(eg, "either-right" = {self.clone(): EitherSort} |right: # (self.right())| -> @EitherContainer (arc) {
            EitherContainer {
                do_rebuild_left: self.ctx.left.is_eq_sort() || self.ctx.left.is_eq_container_sort(),
                do_rebuild_right: self.ctx.right.is_eq_sort() || self.ctx.right.is_eq_container_sort(),
        ...
        add_primitive!(eg, "either-unwrap-left" = |xs: @EitherContainer (arc)| -?> # (self.left()) {
            match xs.data {
        ...
        add_primitive!(eg, "either-unwrap-right" = |xs: @EitherContainer (arc)| -?> # (self.right()) {
            match xs.data {
